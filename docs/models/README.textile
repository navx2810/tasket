...
- Description := this is the text summary of what the collaborators have to do in this task to be considered completed.
- isCurrentlyCompleted := this flag marks the task as completed or not.

*Overriden*

- set IsCompleted(val) := sets *isCurrentlyCompleted* to *val*.
- get IsCompleted := returns *isCurrentlyCompleted*.
